 ...
 */
public class ShowSearchCategoryFragment extends Fragment {

    public static String dtCategory, dtBrand, dtAge;
    ...
    public ShowSearchCategoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_show_search_category, container, false);
        ...
        mRecyclerView = (RecyclerView)view.findViewById(R.id.rcvShowCategory);
        ...
        try {
            ...
            dtCategory= Show.getString("Category");
            dtBrand= Show.getString("Brand");
            dtAge= Show.getString("Age");
    ...
    private void recycleShowCategory() {
        ...
        Ion.with(getContext())
                ...
                .load(Url+"SearchCategory.php")

                .setMultipartParameter("category", dtCategory)
                .setMultipartParameter("brand", dtBrand)
                .setMultipartParameter("age", dtAge)
