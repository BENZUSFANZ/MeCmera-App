...
public class RecyclerViewAdapterSearchPrice extends RecyclerView.Adapter<RecyclerViewAdapterSearchPrice.ViewHolder> {
    ...
    public RecyclerViewAdapterSearchPrice(ArrayList<SearchList> myDataset, Context context, RecyclerView recyclerView){
    ...
    @Override
    public RecyclerViewAdapterSearchPrice.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater inflater = LayoutInflater.from(parent.getContext());

        View view = inflater.inflate(R.layout.custom_view_show_price, parent, false);

        RecyclerViewAdapterSearchPrice.ViewHolder viewHolder = new RecyclerViewAdapterSearchPrice.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(RecyclerViewAdapterSearchPrice.ViewHolder holder, int position) {
